...
void Particle::update(const Perlin &perlin, const vec2 &mouseLocation) {
    ...
    // the above statement is a comprised version of the code below.
//    float nX = mouseLocation.x * 0.005f;
//    float nY = mouseLocation.y * 0.005f;
//    float nZ = (float) getElapsedSeconds() * 0.1f;
//    vec3 v(nX, nY, nZ);
