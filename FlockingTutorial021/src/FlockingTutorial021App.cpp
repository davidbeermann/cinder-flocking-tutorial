...
class FlockingTutorial021App : public App {
public:
    void setup() override;
...
void FlockingTutorial021App::setup() {
    mZoneRadius = 30.0f;
...
void FlockingTutorial021App::update() {
    ...
    // update particles
    mParticleController.applySeparation(mZoneRadius);
    if (mCentralGravity) {
...
void FlockingTutorial021App::draw() {
