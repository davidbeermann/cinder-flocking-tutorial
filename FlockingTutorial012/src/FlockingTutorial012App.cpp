...
class FlockingTutorial012App : public App {
public:
    void setup() override;
...
void FlockingTutorial012App::setup() {
	// CAMERA SETUP
	// ------------
...
void FlockingTutorial012App::update() {
...
void FlockingTutorial012App::draw() {
