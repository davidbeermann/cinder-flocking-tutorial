...
class FlockingTutorial020App : public App {
public:
    void setup() override;
...
void FlockingTutorial020App::setup() {
    mZoneRadius = 30.0f;
...
void FlockingTutorial020App::update() {
    ...
    // update particles
    mParticleController.applySeparation(mZoneRadius*mZoneRadius);
    if (mCentralGravity) {
...
void FlockingTutorial020App::draw() {
